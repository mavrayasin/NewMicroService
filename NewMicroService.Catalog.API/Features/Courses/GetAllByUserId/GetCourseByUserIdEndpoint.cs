...
namespace NewMicroService.Catalog.Api.Features.Courses.GetAllByUserId;

public record GetCourseByUserIdQuery(Guid Id) : ServiceResult.IRequestByServiceResult<List<CourseDto>>;
